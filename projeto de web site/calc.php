...
<head>
  ...
  <script src="finanças.js" defer></script>
  <script src="home.js"></script>
</head>

<body>
  <header>
    <h1>Essa calculadora financeira foi planejada para ajudar as pessoas que não sabem ou não entendem sobre juros ou como calcular o juros.
      Foi pensada para pessoas normais ou para pessoas que tem pequenos negócios. Não é indico para empresas grandes.</h1>
    <div class="main">
      <div class="convert">
        <h3>Conversor</h3><br>
        <label>De:</label>
  ...
  <div class="container">
    ...
    <h2>Existem diversos cálculos financeiros que podem ser feitos, como o cálculo de capacidade de pagamento, índice de rentabilidade, índice de giro do ativo, ciclo financeiro, correção monetária, juros simples e compostos, entre outros:
      Capacidade de pagamento: LC = ativo circulante ÷ passivo circulante
      Índice de rentabilidade: Lucro líquido multiplicado por cem e dividido pelo valor do ativo
      Índice de giro do ativo: Receita líquida dividida pelo total do ativo
      Ciclo financeiro: PMR (prazo médio de recebimento) + PME (prazo médio de estocagem) – PMP (prazo médio de pagamento)
      Correção monetária: Quantia original multiplicada pela variação do índice no período em que o valor ficou defasado
      Juros simples: J = C i t, onde J são os juros, C é o capital, i é a taxa de juros e t é o tempo </h2>
